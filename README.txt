...
a persistence unit "ServidorMorochoCarlosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ServidorMorochoCarlos\pom.xml":
...
artifact ("ServidorMorochoCarlos.war") is already built. You can build
